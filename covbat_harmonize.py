...
def  covbat_harmonize(X_train, X_val, X_test):
    ...
    (X_train_temp, X_val_temp, X_test_temp,
     nan_indices_train, nan_indices_val, nan_indices_test) = impute_by_site_median_with_nan_indices(
        X_train,
        X_val,
        X_test,
        feature_cols=fcols,
    ...
    return X_train_harmonized, X_val_harmonized, X_test_harmonized